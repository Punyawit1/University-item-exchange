...
// ลบความคิดเห็น (ถ้ามี delete_id ใน URL)
...
// ดึงข้อมูลความคิดเห็นพร้อมข้อมูลผู้รีวิวและผู้ถูกรีวิว
...
<title>จัดการความคิดเห็น - ระบบแลกเปลี่ยนสิ่งของ</title>
    ...
    <div class="header-left">
        ...
        <nav class="header-nav">
            ...
            <div class="menu-group">
                ...
                <a href="manage_reviews.php" class="current-page"><i class="fas fa-comments"></i> รีวิว</a>
            </div>
            <div class="menu-group">
...
<div class="container">
    <h2 class="mb-4"><i class="fas fa-comments"></i> จัดการความคิดเห็นของผู้ใช้งาน</h2>
                ...
                <?php if ($result && $result->num_rows > 0): ?>
                    <?php while ($review = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($review['reviewee_name'] ?: '-') ?></td>
                            <td>
                                <?php
                            ...
                            <td>
                                <a href="manage_reviews.php?delete_id=<?= $review['id'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('ยืนยันการลบความคิดเห็นนี้?');"><i class="fas fa-trash-alt"></i> ลบ</a>
                            </td>
                        </tr>
                    <?php endwhile; ?>
                <?php else: ?>
                    <tr>
                        <td colspan="7" class="text-center">ไม่มีความคิดเห็นในระบบ</td>
                    </tr>
                <?php endif; ?>
            </tbody>
        </table>
